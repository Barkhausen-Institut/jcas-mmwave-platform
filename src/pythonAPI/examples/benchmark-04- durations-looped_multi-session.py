...
def main():
    ...
    for k in range(0,range_max):
        ...
        perf.reset("main")
        iA.initialize_hw(mmw.const.instr_hwclass.NI_mmW01, mmw.const.opmodes.BB , 45000) # This is done automatically . Need to be called when reinit needed.
        iB.initialize_hw(mmw.const.instr_hwclass.NI_mmW01, mmw.const.opmodes.RF , 10000) # This is done automatically . Need to be called when reinit needed.
        ...
        conf_fs_list = [(iA, fs, mmw.const.ports.rx),(iA, fs, mmw.const.ports.tx),(iB, fs/2, mmw.const.ports.rx)]
        ...
        #iB.send_trigger(mmw.const.burst_mode.continuous)
