...
def make_linear(t1, f0, f1, N, phase):
    t = np.linspace(0, t1, N)
    w = chirp(t, f0=f0, f1=f1, t1=t1, method='linear', phi=phase)
    return w

def make_quadratic(t1, f0, f1, N, phase):
    t = np.linspace(0, t1, N)
    w = chirp(t, f0=f0, f1=f1, t1=t1, method='quadratic', phi=phase)
    return w
